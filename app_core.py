...
if os.getenv("PUSH_NOTIFICATION"):
    app.config["PUSH_NOTIFICATION"] = True
else:
    app.config["PUSH_NOTIFICATION"] = False

if os.getenv("SHOW_USER_REGISTER"):
    app.config["SHOW_USER_REGISTER"] = True
else:
    app.config["SHOW_USER_REGISTER"] = False
